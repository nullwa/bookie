    ...
    <section className='w-full max-w-wrapper flex items-center justify-center flex-col mx-auto px-6 pt-20 gap-20'>
      ...
      <div className='w-full grid grid-cols-2 gap-4'>
        <div className='flex flex-col gap-4'>
          ...
          <p className='w-full font-medium text-center text-lg first-letter:capitalize'>Preference-aware scheduling</p>
        </div>
        <div className='flex flex-col gap-4'>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <p className='w-full font-medium text-center text-lg first-letter:capitalize'>When priorities shift, your day catches up</p>
        </div>
        <div className='flex flex-col gap-4'>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <p className='w-full font-medium text-center text-lg first-letter:capitalize'>Agentic calendar orchestration</p>
        </div>
        <div className='flex flex-col gap-4'>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <p className='w-full font-medium text-center text-lg first-letter:capitalize'>Internal coordination</p>
        </div>
      </div>
    </section>
  )
