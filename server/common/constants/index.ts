...
export const Constants: Constant = {
  ...
  ROLE_ABILITIES: {
    ...
    [Enum.User.Role.BUSINESS_OWNER]: [Enum.User.Ability.STAFF_VIEW, Enum.User.Ability.STAFF_MOD, Enum.User.Ability.STAFF_DELETE],
    [Enum.User.Role.BUSINESS_STAFF]: [Enum.User.Ability.STAFF_VIEW],
